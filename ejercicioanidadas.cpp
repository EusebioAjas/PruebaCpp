...
//LA ESTRUCTURA VUELO CONTIENE A LA ESTRUCTURA HORA PARA SUS ATRIBUTOS DE HORA DE SALIDA Y HORA DE LLEGADA 
struct vuelo{
	int num;
	hora salida;
	hora llegada;
...
//EN LA FUNCION IMPRIMIR SE CALCULA LA DURACION DEL VUELO, PRIMERO SE ALMACENA EN UN VECTOR DE ESTRUCTURAS PARA LUEGO IMPRIMIRSE EN UN CICLO
void imprimir(int n){
